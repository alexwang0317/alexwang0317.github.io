...
var br = (s, t, n) =>
  t in s
    ? _r(s, t, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (s[t] = n);
var tt = (s, t, n) => (br(s, typeof t != "symbol" ? t + "" : t, n), n);
import {
  S as Oe,
  i as Re,
  s as Ie,
...
import { p as jr } from "../chunks/stores.b61a428f.js";
import { I as Ot } from "../chunks/Icon.cf70abba.js";
import { S as Sr } from "../chunks/Seo.4277da45.js";
import { f as st } from "../chunks/utils.7d7f714d.js";
function zr(s) {
  let t;
  const n = s[2].default,
    e = xt(n, s, s[3], null);
  return {
    ...
    p(i, a) {
      e &&
        e.p &&
        (!t || a & 8) &&
        jt(e, n, i, i[3], t ? zt(n, i[3], a, null) : St(i[3]), null);
    },
    i(i) {
      t || (re(e, i), (t = !0));
    },
...
function Tr(s) {
  let t, n;
  const e = [{ name: "calendar-days" }, s[1], { iconNode: s[0] }];
  let i = { $$slots: { default: [zr] }, $$scope: { ctx: s } };
  for (let a = 0; a < e.length; a += 1) i = ze(i, e[a]);
  return (
    (t = new Ot({ props: i })),
    {
      c() {
      ...
      p(a, [r]) {
        const o =
          r & 3
            ? yt(e, [e[0], r & 2 && $t(a[1]), r & 1 && { iconNode: a[0] }])
            : {};
        r & 8 && (o.$$scope = { dirty: r, ctx: a }), t.$set(o);
      },
      i(a) {
        n || (re(t.$$.fragment, a), (n = !0));
      },
      o(a) {
        se(t.$$.fragment, a), (n = !1);
      },
...
function Or(s, t, n) {
  ...
  return (
    (s.$$set = (r) => {
      n(1, (t = ze(ze({}, t), Ee(r)))), "$$scope" in r && n(3, (i = r.$$scope));
    }),
    (t = Ee(t)),
    [a, t, e, i]
  );
...
function Pr(s) {
  let t, n;
  const e = [{ name: "star" }, s[1], { iconNode: s[0] }];
  let i = { $$slots: { default: [Lr] }, $$scope: { ctx: s } };
  for (let a = 0; a < e.length; a += 1) i = ze(i, e[a]);
  return (
    (t = new Ot({ props: i })),
    {
...
class Dr extends Oe {
  constructor(t) {
    super(), Re(this, t, Mr, Pr, Ie, {});
  }
}
const Rt = Dr;
var It = "Bore – Localhost Tunnels",
  Lt = new Date(16492032e5),
  Pt = "ekzhang/bore",
  Mt = ["Rust", "Systems", "CLI"],
  Dt = "A modern, simple TCP tunnel in 400 lines of Rust.",
  At = "bore.png",
  Ct = `\`bore\` is a minimal CLI tool that exposes local ports to a remote server,
...
var Et = "Char-RNN Keras",
  qt = new Date(15402528e5),
  Gt = "ekzhang/char-rnn-keras",
  Ut = ["Python", "Machine Learning", "Music"],
  Ht =
    "Character-level language models with recurrent neural networks in Keras.",
  Bt = "char-rnn-keras.png",
  Wt = `Inspired by Andrej Karpathy's
...
var Nt = "classes.wtf",
  Ft = new Date(16600896e5),
  Zt = "ekzhang/classes.wtf",
  Vt = ["Go", "TypeScript", "Svelte", "Systems"],
  Qt = "A course catalog with extremely fast full-text search.",
  Jt = "classes-wtf.png",
  Kt = `Harvard has many course search websites, but none of them are good. This project
...
var Yt = "Composing Studio",
  Xt = new Date(16322688e5),
  en = "ekzhang/composing.studio",
  tn = ["TypeScript", "Rust", "Music", "React"],
  nn = "Collaborative music composition for everyone.",
  an = "composing-studio.png",
  rn = `_Composing Studio_ is a free and easy-to-use online music notation editor that
...
var sn = "Crepe – Logic Programming in Rust",
  on = new Date(16008192e5),
  ln = "ekzhang/crepe",
  cn = ["Rust", "Programming Languages", "Datalog"],
  pn = "Fast, compiled Datalog for static analysis, with Rust integration.",
  un = "crepe.png",
  hn = `_Crepe_ is a library that allows you to write declarative logic programs in
...
var gn = "Dispict",
  dn = new Date(16691616e5),
  mn = "ekzhang/dispict",
  fn = ["Python", "Svelte", "Art", "Vision"],
  _n = "Creative aesthetics tool to discover art museums.",
  bn = "dispict.jpg",
  vn = !0,
  kn = `Design a growing artistic exhibit of your own making, with semantic search
...
var wn = "Fast Semantic Segmentation",
  yn = new Date(15981408e5),
  $n = "ekzhang/fastseg",
  xn = ["Python", "Machine Learning", "Vision"],
  jn = "State-of-the-art, real-time semantic segmentation with MobileNetV3.",
  Sn = "fastseg.jpg",
  zn = `While working at Nvidia, I open sourced PyTorch code and pretrained weights for
...
var Tn = "Canvas Hashlife",
  On = new Date(15455232e5),
  Rn = "ekzhang/game-of-life",
  In = ["JavaScript", "Algorithms", "Graphics", "Vue"],
  Ln = "An ultra-fast simulation of Conway's Game of Life in the browser.",
  Pn = "game-of-life.png",
  Mn = `Ever wanted to simulate a 2<sup>100</sup> &times; 2<sup>100</sup> grid of cells
...
var Dn = "Graphics Workshop",
  An = new Date(1619136e6),
  Cn = "ekzhang/graphics-workshop",
  En = ["OpenGL", "Graphics", "Shaders"],
  qn = "Learn computer graphics by writing GPU shaders!",
  Gn = "graphics-workshop.png",
  Un = `This workshop contains a selection of self-guided projects designed to teach the
...
var Hn = "Universal Gravity Simulator",
  Bn = new Date(14639616e5),
  Wn = "ekzhang/gravity",
  Nn = ["JavaScript", "Graphics", "Physics"],
  Fn = "Control hundreds of tiny planets with gravity.",
  Zn = "gravity.png",
  Vn = `This was one of my first fun programming projects, a visual experiment
...
var Qn = "Procedural Harmony",
  Jn = new Date(155088e7),
  Kn = "ekzhang/harmony",
  Yn = ["Python", "Music", "Algorithms", "Flask"],
  Xn = "Dynamic programming applied to four-part harmony.",
  ei = "harmony.png",
  ti = !0,
  ni = `This is a Python program that takes as input a string containing
...
var ii = "Inline SQL",
  ai = new Date(16651872e5),
  ri = "ekzhang/inline-sql",
  si = ["Python", "Programming Languages", "Databases"],
  oi = "Weaving relational queries into the fabric of Python.",
  li = "inline-sql.png",
  ci = `The \`inline-sql\` library provides a simple embedded language for writing SQL in
...
var pi = "Julia Fractal Renderers",
  ui = new Date(15244416e5),
  hi = "ekzhang/julia-fractal",
  gi = ["C++", "Java", "Graphics", "TypeScript", "OpenGL"],
  di = "Fast, interactive fractal renderers in C++, Java, and WebGL.",
  mi = "julia-1.jpg",
  fi = ["julia-2.jpg", "julia-3.jpg", "julia-4.jpg"],
  _i = `Originally, this project started out as a multithreaded Julia fractal renderer
...
var bi = "Langevin Dynamics for Composition",
  vi = new Date(16060896e5),
  ki = "ekzhang/langevin-music",
  wi = ["Python", "Machine Learning", "Music", "Transformers"],
  yi = "Generative modeling of Bach chorales by gradient estimation.",
  $i = "langevin-music.png",
  xi = `This research project introduces a new generative model for music composition,
...
var ji = "Algorithm and Data Structure Library",
  Si = new Date(15482016e5),
  zi = "ekzhang/library",
  Ti = ["C++", "CP", "Algorithms", "Angular"],
  Oi =
    "A competitive programmer's library of algorithms and data structures in C++.",
  Ri = "library.png",
  Ii = `I maintain an open-source library of about thirty-five C++ templates for
...
var Li = "Percival",
  Pi = new Date(16382304e5),
  Mi = "ekzhang/percival",
  Di = ["Rust", "Svelte", "Datalog", "Visualization"],
  Ai = "Web-based, reactive Datalog notebooks.",
  Ci = "percival.png",
  Ei = !0,
  qi = `[Percival](https://percival.ink/) is a **declarative data query and
...
var Gi = "Redis Rope",
  Ui = new Date(16591392e5),
  Hi = "ekzhang/redis-rope",
  Bi = ["Zig", "Rust", "Systems", "Algorithms"],
  Wi = "Fast native data type for manipulating large strings in Redis.",
  Ni = "redis-rope.svg",
  Fi = `\`redis-rope\` is a fast and versatile
...
var Zi = "Path Tracer",
  Vi = new Date(16086816e5),
  Qi = "ekzhang/rpt",
  Ji = ["Rust", "Graphics", "Rendering"],
  Ki = "A physically-based path tracer in Rust.",
  Yi = "rpt.jpg",
  Xi = `This a physically based, CPU-only rendering engine written in Rust. It
...
var ea = "Rushlight",
  ta = new Date(16877376e5),
  na = "ekzhang/rushlight",
  ia = ["TypeScript", "Systems", "Redis"],
  aa = "Collaborative code editors that run on your own infrastructure.",
  ra = "rushlight.jpg",
  sa = `Rushlight is my take on the _essence_ of a persistent, collaborative text editor
...
var oa = "Rustpad",
  la = new Date(16244064e5),
  ca = "ekzhang/rustpad",
  pa = ["Rust", "Systems", "TypeScript", "React"],
  ua = "A self-hosted online collaborative code editor.",
  ha = "rustpad.png",
  ga = `Rustpad is an efficient and minimal collaborative text editor based on the
...
var da = "Set with Friends",
  ma = new Date(15797376e5),
  fa = "ekzhang/setwithfriends",
  _a = ["JavaScript", "Game", "React", "Firebase"],
  ba = "An online, real-time multiplayer card game.",
  va = "setwithfriends.png",
  ka = `_Set with Friends_ is a web implementation of a real-time pattern matching card
...
var wa = "Pencil Sketch Rendering",
  ya = new Date(1621728e6),
  $a = "ekzhang/sketching",
  xa = ["OpenGL", "Graphics", "Geometry", "Algorithms"],
  ja = "Geometry processing for real-time pencil sketching.",
  Sa = "sketching.png",
  za = !0,
  Ta = `This research project explores the task of drawing 3D objects, either triangle
...
var Oa = "sshx",
  Ra = new Date(16991424e5),
  Ia = "ekzhang/sshx",
  La = ["Rust", "Svelte", "Systems"],
  Pa = "A secure web-based, collaborative terminal.",
  Ma = "sshx.png",
  Da = `sshx takes your terminal and shares it on the web. It works on screens of all
...
var Aa = "Polygon Triangulation with Holes",
  Ca = new Date(15585696e5),
  Ea = "ekzhang/triangulate",
  qa = ["C++", "Algorithms", "Emscripten", "Graphics"],
  Ga = "Fast computational geometry algorithms in WebAssembly.",
  Ua = "triangulate.png",
  Ha = `This was an experiment to implement the <em>ear clipping</em> algorithm from
...
var Ba = "µKanren-rs",
  Wa = new Date(16313184e5),
  Na = "ekzhang/ukanren-rs",
  Fa = ["Rust", "Programming Languages", "Systems"],
  Za = "A featherweight relational programming language.",
  Va = "ukanren-rs.png",
  Qa = `This is a Rust implementation of µKanren, a very minimal language in the
...
var Ja = "Handwriting Generator",
  Ka = new Date(15349824e5),
  Ya = "ekzhang/vae-cnn-mnist",
  Xa = ["Python", "Machine Learning", "Graphics"],
  er = "Variational autoencoder that learns latent features in handwriting.",
  tr = "vae-cnn-mnist.png",
  nr = `This is a neural network that encodes 28&times;28 images of handwritten
...
var ir = "Competitive Programming Workspace",
  ar = new Date(15691968e5),
  rr = "ekzhang/wkspace",
  sr = ["JavaScript", "CP", "React", "Express"],
  or = "An online, cloud-synchronized workspace for competitive programmers.",
  lr = "wkspace.png",
  cr = `Top competitive programmers have dedicated setups on their local machines that
...
const Ms = {
  ...
  As = "" + new URL("../assets/bore.c871aed0.png", import.meta.url).href,
  Cs = Object.freeze(
    Object.defineProperty(
  ...
  Es =
    "" + new URL("../assets/char-rnn-keras.c42f556f.png", import.meta.url).href,
  qs = Object.freeze(
    Object.defineProperty(
  ...
  Gs = "" + new URL("../assets/classes-wtf.8c2777c6.png", import.meta.url).href,
  Us = Object.freeze(
    Object.defineProperty(
  ...
  Hs =
    "" +
    new URL("../assets/composing-studio.9747e7e4.png", import.meta.url).href,
  Bs = Object.freeze(
    Object.defineProperty(
  ...
  Ws = "" + new URL("../assets/crepe.9cd3565e.png", import.meta.url).href,
  Ns = Object.freeze(
    Object.defineProperty(
  ...
  Fs = "" + new URL("../assets/dispict.6a5cd3bd.jpg", import.meta.url).href,
  Zs = Object.freeze(
    Object.defineProperty(
  ...
  Vs = "" + new URL("../assets/fastseg.22e6688c.jpg", import.meta.url).href,
  Qs = Object.freeze(
    Object.defineProperty(
  ...
  Js =
    "" + new URL("../assets/game-of-life.0c13ef05.png", import.meta.url).href,
  Ks = Object.freeze(
    Object.defineProperty(
  ...
  Ys =
    "" +
    new URL("../assets/graphics-workshop.8c21b2ee.png", import.meta.url).href,
  Xs = Object.freeze(
    Object.defineProperty(
  ...
  eo = "" + new URL("../assets/gravity.bc8c441c.png", import.meta.url).href,
  to = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: eo },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  no = "" + new URL("../assets/harmony.25e58fd0.png", import.meta.url).href,
  io = Object.freeze(
    Object.defineProperty(
  ...
  ao = "" + new URL("../assets/inline-sql.509c1895.png", import.meta.url).href,
  ro = Object.freeze(
    Object.defineProperty(
  ...
  so = "" + new URL("../assets/julia-1.e84616bd.jpg", import.meta.url).href,
  oo = Object.freeze(
    Object.defineProperty(
  ...
  lo = "" + new URL("../assets/julia-2.d3f67f15.jpg", import.meta.url).href,
  co = Object.freeze(
    Object.defineProperty(
  ...
  po = "" + new URL("../assets/julia-3.ec6a39cb.jpg", import.meta.url).href,
  uo = Object.freeze(
    Object.defineProperty(
  ...
  ho = "" + new URL("../assets/julia-4.7de9e4df.jpg", import.meta.url).href,
  go = Object.freeze(
    Object.defineProperty(
  ...
  mo =
    "" + new URL("../assets/langevin-music.66e4579e.png", import.meta.url).href,
  fo = Object.freeze(
    Object.defineProperty(
  ...
  _o = "" + new URL("../assets/library.88782b31.png", import.meta.url).href,
  bo = Object.freeze(
    Object.defineProperty(
  ...
  vo = "" + new URL("../assets/percival.a6115ad8.png", import.meta.url).href,
  ko = Object.freeze(
    Object.defineProperty(
  ...
  wo = "" + new URL("../assets/redis-rope.e1e2ba4e.svg", import.meta.url).href,
  yo = Object.freeze(
    Object.defineProperty(
  ...
  $o = "" + new URL("../assets/rpt.fb795885.jpg", import.meta.url).href,
  xo = Object.freeze(
    Object.defineProperty(
  ...
  jo = "" + new URL("../assets/rushlight.7db2943a.jpg", import.meta.url).href,
  So = Object.freeze(
    Object.defineProperty(
  ...
  zo = "" + new URL("../assets/rustpad.2cbc1bb1.png", import.meta.url).href,
  To = Object.freeze(
    Object.defineProperty(
  ...
  Oo =
    "" + new URL("../assets/setwithfriends.e814f490.png", import.meta.url).href,
  Ro = Object.freeze(
    Object.defineProperty(
  ...
  Io = "" + new URL("../assets/sketching.8c77a336.png", import.meta.url).href,
  Lo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Io },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  Po = "" + new URL("../assets/sshx.ea086053.png", import.meta.url).href,
  Mo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Po },
      Symbol.toStringTag,
  ...
  Do = "" + new URL("../assets/triangulate.9c829ea2.png", import.meta.url).href,
  Ao = Object.freeze(
    Object.defineProperty(
  ...
  Co = "" + new URL("../assets/ukanren-rs.b09debb9.png", import.meta.url).href,
  Eo = Object.freeze(
    Object.defineProperty(
  ...
  qo =
    "" + new URL("../assets/vae-cnn-mnist.2c640af4.png", import.meta.url).href,
  Go = Object.freeze(
    Object.defineProperty(
  ...
  Uo = "" + new URL("../assets/wkspace.a04b6a8c.png", import.meta.url).href,
  Ho = Object.freeze(
    Object.defineProperty(
...
const ur = /[&<>"']/,
  Wo = new RegExp(ur.source, "g"),
  hr = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  No = new RegExp(hr.source, "g"),
  Fo = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  ot = (s) => Fo[s];
function X(s, t) {
  if (t) {
    if (ur.test(s)) return s.replace(Wo, ot);
  } else if (hr.test(s)) return s.replace(No, ot);
  return s;
}
const Zo = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
function gr(s) {
  return s.replace(
    Zo,
    (t, n) => (
...
function I(s, t) {
  ...
  const n = {
    replace: (e, i) => (
      (i = i.source || i), (i = i.replace(Vo, "$1")), (s = s.replace(e, i)), n
    ),
...
function lt(s, t, n) {
  if (s) {
    let e;
    try {
      e = decodeURIComponent(gr(n)).replace(Qo, "").toLowerCase();
    } catch {
      return null;
    }
    if (
...
const Ge = { exec: function () {} };
function ct(s, t) {
  const n = s.replace(/\|/g, (a, r, o) => {
      let l = !1,
        c = r;
      for (; --c >= 0 && o[c] === "\\"; ) l = !l;
      return l ? "|" : " |";
...
function Ce(s, t, n) {
  ...
  let i = 0;
  for (; i < e; ) {
    const a = s.charAt(e - i - 1);
    if (a === t && !n) i++;
    else if (a !== t && n) i++;
    else break;
  }
  return s.slice(0, e - i);
}
function tl(s, t) {
  ...
  for (; i < n; i++)
    ...
    else if (s[i] === t[1] && (e--, e < 0)) return i;
  return -1;
}
function nl(s) {
  s &&
...
function pt(s, t) {
  if (t < 1) return "";
  let n = "";
  for (; t > 1; ) t & 1 && (n += s), (t >>= 1), (s += s);
  return n + s;
}
function ut(s, t, n, e) {
  const i = t.href,
    a = t.title ? X(t.title) : null,
    r = s[1].replace(/\\([\[\]])/g, "$1");
  if (s[0].charAt(0) !== "!") {
    e.state.inLink = !0;
    const o = {
  ...
  return { type: "image", raw: n, href: i, title: a, text: X(r) };
}
function il(s, t) {
  const n = s.match(/^(\s+)(?:```)/);
  if (n === null) return t;
  ...
  blockquote(t) {
    ...
    if (n) {
      ...
      return (
        ...
        { type: "blockquote", raw: n[0], tokens: a, text: e }
      );
    }
  }
  list(t) {
    ...
    if (n) {
      ...
      for (
        ;
        t && ((O = !1), !(!(n = T.exec(t)) || this.rules.block.hr.test(t)));
...
`,
            ...
            this.options.pedantic &&
              (m = m.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")),
            !(D.test(m) || N.test(m) || G.test(m) || C.test(t)));
...
`),
      ...
      const W = x.items.length;
      for (o = 0; o < W; o++)
        if (
          ((this.lexer.state.top = !1),
          (x.items[o].tokens = this.lexer.blockTokens(x.items[o].text, [])),
          !x.loose)
        ) {
          const G = x.items[o].tokens.filter((D) => D.type === "space"),
            C = G.length > 0 && G.some((D) => /\n.*\n/.test(D.raw));
          x.loose = C;
        }
      if (x.loose) for (o = 0; o < W; o++) x.items[o].loose = !0;
      return x;
    }
  }
  html(t) {
      ...
      const e = n[1].toLowerCase().replace(/\s+/g, " "),
        ...
        a = n[3]
          ? n[3]
              ...
              .replace(this.rules.inline._escapes, "$1")
          : n[3];
      return { type: "def", tag: e, raw: n[0], href: i, title: a };
    }
  }
  table(t) {
...
`
  ...
  escape(t) {
    ...
    if (n) return { type: "escape", raw: n[0], text: X(n[1]) };
  }
  tag(t) {
  ...
  link(t) {
    ...
    if (n) {
      ...
      if (!this.options.pedantic && /^</.test(e)) {
        if (!/>$/.test(e)) return;
        const r = Ce(e.slice(0, -1), "\\");
        if ((e.length - r.length) % 2 === 0) return;
      } else {
        const r = tl(n[2], "()");
        if (r > -1) {
          const l = (n[0].indexOf("!") === 0 ? 5 : 4) + n[1].length + r;
  ...
  emStrong(t, n, e = "") {
    ...
    if (!a || (a && (e === "" || this.rules.inline.punctuation.exec(e)))) {
      ...
      for (
        m.lastIndex = 0, n = n.slice(-1 * t.length + r);
        (i = m.exec(n)) != null;
        ...
        if (((c -= l), c > 0)) continue;
        l = Math.min(l, l + c + u);
        const y = t.slice(0, r + i.index + (i[0].length - o.length) + l);
        if (Math.min(r, l) % 2) {
          const O = y.slice(1, -1);
          return {
            type: "em",
  ...
  codespan(t) {
    ...
    if (n) {
      ...
      const i = /[^ ]/.test(e),
        a = /^ /.test(e) && / $/.test(e);
      return (
        i && a && (e = e.substring(1, e.length - 1)),
        (e = X(e, !0)),
  ...
  autolink(t, n) {
    ...
    if (e) {
      ...
      return (
        e[2] === "@"
          ? ((i = X(this.options.mangle ? n(e[1]) : e[1])), (a = "mailto:" + i))
          : ((i = X(e[1])), (a = i)),
        {
          type: "link",
          raw: e[0],
  ...
  url(t, n) {
    ...
    if ((e = this.rules.inline.url.exec(t))) {
      let i, a;
      if (e[2] === "@")
        (i = X(this.options.mangle ? n(e[0]) : e[0])), (a = "mailto:" + i);
      else {
        let r;
        do (r = e[0]), (e[0] = this.rules.inline._backpedal.exec(e[0])[0]);
        while (r !== e[0]);
        (i = X(e[0])), e[1] === "www." ? (a = "http://" + e[0]) : (a = e[0]);
      }
      return {
        type: "link",
        raw: e[0],
        ...
        this.lexer.state.inRawBlock
          ? (i = this.options.sanitize
              ? this.options.sanitizer
                ...
                : X(e[0])
              : e[0])
          : (i = X(this.options.smartypants ? n(e[0]) : e[0])),
...
w.paragraph = I(w._paragraph)
  ...
  .replace("tag", w._tag)
  .getRegex();
w.blockquote = I(w.blockquote).replace("paragraph", w.paragraph).getRegex();
w.normal = { ...w };
w.gfm = {
  ...w.normal,
  table:
...
w.gfm.table = I(w.gfm.table)
  ...
  .replace("tag", w._tag)
  .getRegex();
w.gfm.paragraph = I(w._paragraph)
  .replace("hr", w.hr)
  .replace("heading", " {0,3}#{1,6} ")
  .replace("|lheading", "")
...
w.pedantic = {
  ...
  fences: Ge,
  lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
  paragraph: I(w.normal._paragraph)
    .replace("hr", w.hr)
    .replace(
      "heading",
      ` *#{1,6} *[^
...
g._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~";
g.punctuation = I(g.punctuation)
  .replace(/punctuation/g, g._punctuation)
  .getRegex();
g.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g;
g.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g;
g._comment = I(w._comment).replace("(?:-->|$)", "-->").getRegex();
g.emStrong.lDelim = I(g.emStrong.lDelim)
  .replace(/punct/g, g._punctuation)
  .getRegex();
g.emStrong.rDelimAst = I(g.emStrong.rDelimAst, "g")
  .replace(/punct/g, g._punctuation)
  .getRegex();
g.emStrong.rDelimUnd = I(g.emStrong.rDelimUnd, "g")
  .replace(/punct/g, g._punctuation)
  .getRegex();
g._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g;
...
g.link = I(g.link)
  ...
  .getRegex();
g.reflink = I(g.reflink)
  .replace("label", g._label)
  .replace("ref", w._label)
  .getRegex();
g.nolink = I(g.nolink).replace("ref", w._label).getRegex();
g.reflinkSearch = I(g.reflinkSearch, "g")
...
g.gfm = {
  ...g.normal,
  escape: I(g.escape).replace("])", "~|])").getRegex(),
  _extended_email:
...
g.gfm.url = I(g.gfm.url, "i")
  .replace("email", g.gfm._extended_email)
  .getRegex();
g.breaks = {
  ...g.gfm,
  br: I(g.br).replace("{2,}", "*").getRegex(),
  text: I(g.gfm.text)
    .replace("\\b_", "\\b_| {2,}\\n")
    .replace(/\{2,\}/g, "*")
    .getRegex(),
...
class be {
  constructor(t) {
    (this.tokens = []),
      ...
      (this.options = t || xe),
      (this.options.tokenizer = this.options.tokenizer || new Fe()),
      (this.tokenizer = this.options.tokenizer),
      (this.tokenizer.options = this.options),
      (this.tokenizer.lexer = this),
      (this.inlineQueue = []),
      (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
    const n = { block: w.normal, inline: g.normal };
    this.options.pedantic
      ? ((n.block = w.pedantic), (n.inline = g.pedantic))
      : this.options.gfm &&
        ((n.block = w.gfm),
        this.options.breaks ? (n.inline = g.breaks) : (n.inline = g.gfm)),
      (this.tokenizer.rules = n);
  }
  static get rules() {
    return { block: w, inline: g };
  }
  static lex(t, n) {
  ...
  inlineTokens(t, n = []) {
    ...
    if (this.tokens.links) {
      ...
      if (u.length > 0)
        for (
          ;
          (o = this.tokenizer.rules.inline.reflinkSearch.exec(r)) != null;
    ...
    for (; (o = this.tokenizer.rules.inline.escapedEmSt.exec(r)) != null; )
      (r =
        r.slice(0, o.index + o[0].length - 2) +
        "++" +
...
`;
  ...
  heading(t, n, e, i) {
    if (this.options.headerIds) {
      const a = this.options.headerPrefix + i.slug(e);
...
`
  ...
  link(t, n, e) {
    if (((t = lt(this.options.sanitize, this.options.baseUrl, t)), t === null))
      return e;
    let i = '<a href="' + t + '"';
...
class ve {
  constructor(t) {
    (this.options = t || xe),
      (this.options.renderer = this.options.renderer || new Ze()),
      (this.renderer = this.options.renderer),
      (this.renderer.options = this.options),
      (this.textRenderer = new dr()),
      (this.slugger = new mr());
  }
  static parse(t, n) {
      ...
      switch (p.type) {
        ...
        case "heading": {
          e += this.renderer.heading(
            ...
            p.depth,
            gr(this.parseInline(p.tokens, this.textRenderer)),
            this.slugger
          );
          continue;
        }
        ...
        case "table": {
          for (m = "", u = "", o = p.header.length, a = 0; a < o; a++)
            u += this.renderer.tablecell(this.parseInline(p.header[a].tokens), {
              header: !0,
              align: p.align[a],
            });
          for (
            m += this.renderer.tablerow(u), y = "", o = p.rows.length, a = 0;
            a < o;
            a++
          ) {
            for (c = p.rows[a], u = "", l = c.length, r = 0; r < l; r++)
              u += this.renderer.tablecell(this.parseInline(c[r].tokens), {
                header: !1,
                align: p.align[r],
              });
            y += this.renderer.tablerow(u);
          }
          e += this.renderer.table(m, y);
          continue;
        }
        case "blockquote": {
          (y = this.parse(p.tokens)), (e += this.renderer.blockquote(y));
          continue;
        }
        case "list": {
          for (
            ...
            (T = p.items[a]),
              ...
              (x = ""),
              T.task &&
                ((C = this.renderer.checkbox(W)),
                L
                  ? T.tokens.length > 0 && T.tokens[0].type === "paragraph"
                    ? ((T.tokens[0].text = C + " " + T.tokens[0].text),
                      T.tokens[0].tokens &&
                        T.tokens[0].tokens.length > 0 &&
                        T.tokens[0].tokens[0].type === "text" &&
                        (T.tokens[0].tokens[0].text =
                          C + " " + T.tokens[0].tokens[0].text))
                    : T.tokens.unshift({ type: "text", text: C })
                  : (x += C)),
              (x += this.parse(T.tokens, L)),
              (y += this.renderer.listitem(x, G, W));
          e += this.renderer.list(y, O, R);
          continue;
        }
        case "html": {
        ...
        case "text": {
          for (
            y = p.tokens ? this.parseInline(p.tokens) : p.text;
            i + 1 < N && t[i + 1].type === "text";
...
` + (p.tokens ? this.parseInline(p.tokens) : p.text));
        ...
        default: {
          const F = 'Token with "' + p.type + '" type was not found.';
          if (this.options.silent) {
            console.error(F);
            return;
  ...
  parseInline(t, n) {
    ...
    for (i = 0; i < o; i++) {
      ...
      switch (a.type) {
        ...
        case "link": {
          e += n.link(a.href, a.title, this.parseInline(a.tokens, n));
          break;
        }
        case "image": {
          e += n.image(a.href, a.title, a.text);
          break;
        }
        case "strong": {
          e += n.strong(this.parseInline(a.tokens, n));
          break;
        }
        case "em": {
          e += n.em(this.parseInline(a.tokens, n));
          break;
        }
        case "codespan": {
          e += n.codespan(a.text);
        ...
        case "del": {
          e += n.del(this.parseInline(a.tokens, n));
          break;
        }
        case "text": {
          e += n.text(a.text);
...
tt(Ue, "passThroughHooks", new Set(["preprocess", "postprocess"]));
function rl(s, t, n) {
  return (e) => {
    if (
      ((e.message += `
Please report this to https://github.com/markedjs/marked.`),
      ...
      const i =
        "<p>An error occurred:</p><pre>" + X(e.message + "", !0) + "</pre>";
...
function fr(s, t) {
  return (n, e, i) => {
    ...
    if ((nl(e), e.hooks && (e.hooks.options = e), i)) {
      const o = e.highlight;
      let l;
      try {
        e.hooks && (n = e.hooks.preprocess(n)), (l = s(n, e));
      } catch (m) {
        return r(m);
      }
      const c = function (m) {
        ...
        if (!m)
          try {
            e.walkTokens && k.walkTokens(l, e.walkTokens),
              (y = t(l, e)),
              e.hooks && (y = e.hooks.postprocess(y));
          } catch (p) {
            m = p;
          }
        return (e.highlight = o), m ? r(m) : i(null, y);
      };
      if (!o || o.length < 3 || (delete e.highlight, !l.length)) return c();
      let u = 0;
      k.walkTokens(l, function (m) {
        m.type === "code" &&
          (u++,
          setTimeout(() => {
            o(m.text, m.lang, function (y, p) {
              if (y) return c(y);
              p != null && p !== m.text && ((m.text = p), (m.escaped = !0)),
                u--,
                u === 0 && c();
            });
          }, 0));
    ...
    if (e.async)
      return Promise.resolve(e.hooks ? e.hooks.preprocess(n) : n)
        ...
        .then((o) =>
          e.walkTokens
            ? Promise.all(k.walkTokens(o, e.walkTokens)).then(() => o)
            : o
        )
        .then((o) => t(o, e))
        .then((o) => (e.hooks ? e.hooks.postprocess(o) : o))
        .catch(r);
    try {
      e.hooks && (n = e.hooks.preprocess(n));
      const o = s(n, e);
      e.walkTokens && k.walkTokens(o, e.walkTokens);
      let l = t(o, e);
      return e.hooks && (l = e.hooks.postprocess(l)), l;
    } catch (o) {
      return r(o);
    }
  };
...
function k(s, t, n) {
  return fr(be.lex, ve.parse)(s, t, n);
}
k.options = k.setOptions = function (s) {
  return (k.defaults = { ...k.defaults, ...s }), Bo(k.defaults), k;
};
k.getDefaults = pr;
k.defaults = xe;
k.use = function (...s) {
  const t = k.defaults.extensions || { renderers: {}, childTokens: {} };
  s.forEach((n) => {
    const e = { ...n };
    if (
      ...
      const i = k.defaults.renderer || new Ze();
      for (const a in n.renderer) {
        const r = i[a];
        i[a] = (...o) => {
          let l = n.renderer[a].apply(i, o);
          return l === !1 && (l = r.apply(i, o)), l;
        };
      }
      e.renderer = i;
    }
    if (n.tokenizer) {
      const i = k.defaults.tokenizer || new Fe();
      for (const a in n.tokenizer) {
        const r = i[a];
        i[a] = (...o) => {
          let l = n.tokenizer[a].apply(i, o);
          return l === !1 && (l = r.apply(i, o)), l;
        };
      }
      e.tokenizer = i;
    ...
    if (n.hooks) {
      const i = k.defaults.hooks || new Ue();
      for (const a in n.hooks) {
        const r = i[a];
        Ue.passThroughHooks.has(a)
          ? (i[a] = (o) => {
              if (k.defaults.async)
                return Promise.resolve(n.hooks[a].call(i, o)).then((c) =>
                  r.call(i, c)
                );
              const l = n.hooks[a].call(i, o);
              return r.call(i, l);
            })
          : (i[a] = (...o) => {
              let l = n.hooks[a].apply(i, o);
              return l === !1 && (l = r.apply(i, o)), l;
            });
      }
      e.hooks = i;
    ...
    if (n.walkTokens) {
      ...
      e.walkTokens = function (a) {
        let r = [];
        return (
          r.push(n.walkTokens.call(this, a)),
          i && (r = r.concat(i.call(this, a))),
          r
        );
      };
    }
...
k.walkTokens = function (s, t) {
  let n = [];
  for (const e of s)
    switch (((n = n.concat(t.call(k, e))), e.type)) {
      case "table": {
        for (const i of e.header) n = n.concat(k.walkTokens(i.tokens, t));
        for (const i of e.rows)
          for (const a of i) n = n.concat(k.walkTokens(a.tokens, t));
        break;
      }
      case "list": {
        n = n.concat(k.walkTokens(e.items, t));
        break;
      }
      default:
        ...
        k.defaults.extensions.childTokens[e.type]
          ? k.defaults.extensions.childTokens[e.type].forEach(function (i) {
              n = n.concat(k.walkTokens(e[i], t));
            })
          : e.tokens && (n = n.concat(k.walkTokens(e.tokens, t)));
    }
  return n;
};
k.parseInline = fr(be.lexInline, ve.parseInline);
k.Parser = ve;
k.parser = ve.parse;
k.Renderer = Ze;
k.TextRenderer = dr;
...
function sl(s) {
  ...
  return {
    ...
    h() {
      b(t, "class", "md-output svelte-19wf98v");
    },
    m(n, e) {
      q(n, t, e), (t.innerHTML = s[0]);
    },
    p(n, [e]) {
      e & 1 && (t.innerHTML = n[0]);
    },
...
function ol(s, t, n) {
  ...
  return (
    k.use({
      renderer: {
        link(a, r, o) {
          let l = `<a rel="external" href="${encodeURI(a)}" class="link"`;
          return r && (l += ' title="' + r + '"'), (l += ">" + o + "</a>"), l;
        },
      },
    }),
    (s.$$set = (a) => {
      "source" in a && n(1, (i = a.source));
    }),
    (s.$$.update = () => {
      s.$$.dirty & 2 &&
        n(0, (e = k.parse(i, { smartLists: !0, smartypants: !0 })));
    }),
    [e, i]
  );
}
class ll extends Oe {
  constructor(t) {
    super(), Re(this, t, ol, sl, Ie, { source: 1 });
  }
}
function gt(s, t, n) {
  const e = s.slice();
...
function pl(s) {
  let t,
    n = s[2][s[0].repo].toLocaleString() + "",
    e;
  return {
    c() {
      (t = j("span")), (e = V(n)), this.h();
    },
    l(i) {
      t = S(i, "SPAN", { class: !0 });
      var a = z(t);
      (e = Q(a, n)), a.forEach(f), this.h();
    },
    h() {
      b(t, "class", "ml-1");
    },
    ...
    p(i, a) {
      a & 5 && n !== (n = i[2][i[0].repo].toLocaleString() + "") && Se(e, n);
    },
    d(i) {
      i && f(t);
    },
...
function ft(s) {
  let t,
    n = s[0].subimages,
    e = [];
  for (let i = 0; i < n.length; i += 1) e[i] = _t(gt(s, n, i));
  return {
    c() {
      t = j("div");
    ...
    l(i) {
      t = S(i, "DIV", { class: !0 });
      var a = z(t);
      for (let r = 0; r < e.length; r += 1) e[r].l(a);
      a.forEach(f), this.h();
    },
    h() {
      b(t, "class", "grid grid-cols-3 gap-4 md:gap-8 lg:gap-12");
    },
    m(i, a) {
      q(i, t, a);
    ...
    p(i, a) {
      if (a & 3) {
        ...
        for (r = 0; r < n.length; r += 1) {
          const o = gt(i, n, r);
          e[r] ? e[r].p(o, a) : ((e[r] = _t(o)), e[r].c(), e[r].m(t, null));
        }
...
function _t(s) {
  ...
  return {
    c() {
      (t = j("div")), (n = j("a")), (e = j("img")), (o = H()), this.h();
    },
    l(l) {
      t = S(l, "DIV", { class: !0 });
      var c = z(t);
      n = S(c, "A", { rel: !0, href: !0 });
      var u = z(n);
      (e = S(u, "IMG", { src: !0, alt: !0 })),
        u.forEach(f),
        (o = B(c)),
        c.forEach(f),
        this.h();
    ...
    h() {
      ...
      qe(
        e.src,
        (i = (l = s[1][`../../projects/${s[3]}`]) == null ? void 0 : l.default)
      ) || b(e, "src", i),
        b(e, "alt", (a = s[0].title + " subimage")),
        b(n, "rel", "external"),
        b(
          n,
          "href",
          (r =
            (c = s[1][`../../projects/${s[3]}`]) == null ? void 0 : c.default)
        ),
        b(t, "class", "col-span-full md:col-span-1");
    },
    m(l, c) {
      q(l, t, c), _(t, n), _(n, e), _(t, o);
    },
    p(l, c) {
      var u, m;
      c & 3 &&
        !qe(
          e.src,
          (i =
            (u = l[1][`../../projects/${l[3]}`]) == null ? void 0 : u.default)
        ) &&
        b(e, "src", i),
        c & 1 && a !== (a = l[0].title + " subimage") && b(e, "alt", a),
        c & 3 &&
          r !==
            (r =
              (m = l[1][`../../projects/${l[3]}`]) == null
                ? void 0
                : m.default) &&
          b(n, "href", r);
    },
...
function ul(s) {
  ...
  function le(d, $) {
    var Y;
    return ((Y = d[2]) == null ? void 0 : Y[d[0].repo]) !== void 0 ? pl : cl;
  }
  let he = le(s),
    ee = he(s),
    J = s[0].topics,
    P = [];
  for (let d = 0; d < J.length; d += 1) P[d] = mt(dt(s, J, d));
  F = new ll({ props: { source: s[0].content } });
  let U = s[0].subimages && ft(s);
  return {
    c() {
      (t = j("h3")),
        (n = j("span")),
    ...
    l(d) {
      ...
      (l = Q(ae, o)),
        ...
        (u = S(d, "DIV", { class: !0 }));
      var te = z(u);
      m = S(te, "A", { class: !0, href: !0 });
      var E = z(m);
      me(y.$$.fragment, E), (p = B(E)), ee.l(E), E.forEach(f), (R = B(te));
      for (let v = 0; v < P.length; v += 1) P[v].l(te);
      te.forEach(f), (L = B(d)), (x = S(d, "DIV", { class: !0 }));
      var ce = z(x);
      T = S(ce, "DIV", { class: !0 });
      var ue = z(T);
      W = S(ue, "DIV", { class: !0 });
      ...
      (D = Q(ge, C)),
        ...
        (oe = S(ue, "DIV", { class: !0 }));
      var Te = z(oe);
      K = S(Te, "A", { rel: !0, href: !0 });
      var h = z(K);
      (M = S(h, "IMG", { src: !0, alt: !0 })),
        h.forEach(f),
        Te.forEach(f),
        ue.forEach(f),
        (ie = B(ce)),
    ...
    h() {
      ...
      b(n, "class", "mr-1"),
        ...
        b(t, "class", "text-black text-xl font-semibold mb-2"),
        b(
          m,
          "class",
          "pill hover:!bg-neutral-200 transition-colors svelte-1d8a62h"
        ),
        b(m, "href", (O = "https://github.com/" + s[0].repo + "/stargazers")),
        b(u, "class", "flex flex-wrap mb-1"),
        b(G, "class", "text-lg font-light mb-3"),
        b(W, "class", "col-span-3 md:col-span-2"),
        qe(
          M.src,
          (we =
            (d = s[1][`../../projects/${s[0].image}`]) == null
              ? void 0
              : d.default)
        ) || b(M, "src", we),
        b(M, "alt", (pe = s[0].title + " preview image")),
        je(M, "border", s[0].image_border),
        b(K, "rel", "external"),
        b(
          K,
          "href",
          (ne =
            ($ = s[1][`../../projects/${s[0].image}`]) == null
              ? void 0
              : $.default)
        ),
        b(oe, "class", "col-span-3 md:col-span-1"),
        b(T, "class", "grid grid-cols-3 gap-4 md:gap-8 lg:gap-12"),
        b(x, "class", "space-y-4");
    },
    m(d, $) {
      q(d, t, $),
        ...
        ee.m(m, null),
        _(u, R);
      for (let Y = 0; Y < P.length; Y += 1) P[Y] && P[Y].m(u, null);
      q(d, L, $),
        q(d, x, $),
        _(x, T),
        _(T, W),
    ...
    p(d, [$]) {
      var ae, te;
      if (
        ((!A || $ & 1) && e !== (e = d[0].title + "") && Se(i, e),
        (!A || $ & 1) && o !== (o = st("%B %Y", d[0].date) + "") && Se(l, o),
        he === (he = le(d)) && ee
          ? ee.p(d, $)
          : (ee.d(1), (ee = he(d)), ee && (ee.c(), ee.m(m, null))),
        (!A ||
          ($ & 1 &&
            O !== (O = "https://github.com/" + d[0].repo + "/stargazers"))) &&
          b(m, "href", O),
        $ & 1)
      ) {
        J = d[0].topics;
        ...
        for (E = 0; E < J.length; E += 1) {
          const ce = dt(d, J, E);
          P[E] ? P[E].p(ce, $) : ((P[E] = mt(ce)), P[E].c(), P[E].m(u, null));
        }
        for (; E < P.length; E += 1) P[E].d(1);
        P.length = J.length;
      }
      (!A || $ & 1) && C !== (C = d[0].lead + "") && Se(D, C);
      const Y = {};
      $ & 1 && (Y.source = d[0].content),
        F.$set(Y),
        (!A ||
          ($ & 3 &&
            !qe(
              M.src,
              (we =
                (ae = d[1][`../../projects/${d[0].image}`]) == null
                  ? void 0
                  : ae.default)
            ))) &&
          b(M, "src", we),
        (!A || ($ & 1 && pe !== (pe = d[0].title + " preview image"))) &&
          b(M, "alt", pe),
        (!A || $ & 1) && je(M, "border", d[0].image_border),
        (!A ||
          ($ & 3 &&
            ne !==
              (ne =
                (te = d[1][`../../projects/${d[0].image}`]) == null
                  ? void 0
                  : te.default))) &&
          b(K, "href", ne),
        d[0].subimages
          ? U
            ? U.p(d, $)
            : ((U = ft(d)), U.c(), U.m(x, null))
          : U && (U.d(1), (U = null));
    },
    i(d) {
      A || (re(y.$$.fragment, d), re(F.$$.fragment, d), (A = !0));
    },
    o(d) {
      se(y.$$.fragment, d), se(F.$$.fragment, d), (A = !1);
    },
    d(d) {
      d && f(t),
        d && f(c),
...
class gl extends Oe {
  constructor(t) {
    super(), Re(this, t, hl, ul, Ie, { data: 0, images: 1, stars: 2 });
  }
}
function bt(s, t, n) {
  const e = s.slice();
...
function kt(s, t) {
  ...
  return {
    ...
    first: null,
    c() {
      (n = j("li")), (e = j("a")), (a = V(i)), (o = H()), this.h();
    },
    l(l) {
      n = S(l, "LI", {});
      var c = z(n);
      e = S(c, "A", { class: !0, href: !0 });
      var u = z(e);
      (a = Q(u, i)), u.forEach(f), (o = B(c)), c.forEach(f), this.h();
    },
    h() {
      b(e, "class", "link"),
        b(e, "href", (r = "#" + He(t[10]))),
    ...
    m(l, c) {
      q(l, n, c), _(n, e), _(e, a), _(n, o);
    },
    p(l, c) {
      (t = l),
        c & 2 && i !== (i = t[5][t[10]].title + "") && Se(a, i),
        c & 2 && r !== (r = "#" + He(t[10])) && b(e, "href", r);
    },
    d(l) {
      l && f(n);
    },
...
function wt(s, t) {
  let n, e, i, a, r, o;
  return (
    (i = new gl({ props: { data: t[5][t[10]], images: t[6], stars: t[0] } })),
    {
      key: s,
      first: null,
      c() {
      ...
      l(l) {
        n = S(l, "SECTION", { class: !0, id: !0 });
        var c = z(n);
        e = S(c, "DIV", { class: !0 });
        var u = z(e);
        me(i.$$.fragment, u), u.forEach(f), (a = B(c)), c.forEach(f), this.h();
      },
      h() {
        b(e, "class", "mx-auto max-w-[1152px] px-4 sm:px-6"),
          b(n, "class", "py-10"),
          b(n, "id", (r = He(t[10]))),
          (this.first = n);
      },
      m(l, c) {
        q(l, n, c), _(n, e), fe(i, e, null), _(n, a), (o = !0);
      },
      p(l, c) {
        t = l;
        const u = {};
        c & 28 && (u.data = t[5][t[10]]),
          c & 1 && (u.stars = t[0]),
          i.$set(u),
          (!o || (c & 28 && r !== (r = He(t[10])))) && b(n, "id", r);
      },
      i(l) {
        o || (re(i.$$.fragment, l), (o = !0));
      },
      o(l) {
        se(i.$$.fragment, l), (o = !1);
      },
...
function dl(s) {
  ...
  (le = new Ir({ props: { size: 18, strokeWidth: 1.8, class: "mr-1.5" } })),
    (P = new Rt({ props: { size: 18, strokeWidth: 1.8, class: "mr-1.5" } }));
  let ge = s[2] === "date" ? s[4] : s[3];
  const Te = (h) => h[10];
  ...
  return {
    c() {
      de(t.$$.fragment),
        ...
        (r = H()),
        (o = j("p")),
        (l = V("I view building software in the open as a mode of ")),
        (c = j("em")),
        (u = V("creative exploration")),
        (m =
          V(`. It lets me quickly act on inspiration, delve into new topics, and make
    tools that improve people's lives.`)),
        (y = H()),
        (p = j("p")),
        (O =
          V(`You'll see that I particularly like programming languages, distributed
    systems, machine learning, computer graphics, music, and art.`)),
        (R = H()),
        (L = j("p")),
        (x = V(`If you find something interesting,
    `)),
        (T = j("a")),
        (W = V("let me know")),
        (G = V("!")),
    ...
    l(h) {
      me(t.$$.fragment, h), (n = B(h)), (e = S(h, "SECTION", { class: !0 }));
      var v = z(e);
      i = S(v, "H2", { class: !0 });
      var Z = z(i);
      (a = Q(Z, "Open Source")),
        ...
        (o = S(v, "P", { class: !0 }));
      var Le = z(o);
      (l = Q(Le, "I view building software in the open as a mode of ")),
        (c = S(Le, "EM", { class: !0 }));
      var Ve = z(c);
      (u = Q(Ve, "creative exploration")),
        Ve.forEach(f),
        (m = Q(
          Le,
    ...
    `
      ...
      (W = Q(Je, "let me know")),
        ...
        (D = S(h, "DIV", { class: !0 }));
      var Ke = z(D);
      N = S(Ke, "SECTION", { class: !0 });
      var Me = z(N);
      F = S(Me, "H2", { class: !0 });
      var Ye = z(F);
      (ke = Q(Ye, "Table of Contents")),
        Ye.forEach(f),
        (oe = B(Me)),
        (K = S(Me, "UL", { class: !0 }));
      var Xe = z(K);
      for (let $e = 0; $e < M.length; $e += 1) M[$e].l(Xe);
      Xe.forEach(f),
        Me.forEach(f),
        Ke.forEach(f),
        (pe = B(h)),
      ...
      ie = S(et, "DIV", { class: !0 });
      var De = z(ie);
      A = S(De, "BUTTON", { class: !0 });
      var Be = z(A);
      me(le.$$.fragment, Be),
        (he = Q(Be, " by Date")),
        Be.forEach(f),
        (ee = B(De)),
        (J = S(De, "BUTTON", { class: !0 }));
      var We = z(J);
      me(P.$$.fragment, We),
        (U = Q(We, " by Stars")),
        We.forEach(f),
        ...
        et.forEach(f),
        (d = B(h));
      for (let $e = 0; $e < $.length; $e += 1) $[$e].l(h);
      (ae = nt()), this.h();
    },
    h() {
      b(i, "class", "heading2"),
        b(c, "class", "font-serif text-[110%] leading-[100%]"),
        b(o, "class", "text-lg mb-4"),
        b(p, "class", "text-lg mb-4"),
        b(T, "class", "link"),
        b(T, "href", "mailto:ekzhang1@gmail.com?subject=Software%20Projects"),
        b(L, "class", "text-lg"),
        b(e, "class", "layout-md py-12"),
        b(F, "class", "heading2 text-white"),
        b(K, "class", "sm:columns-2"),
        b(N, "class", "layout-md py-12"),
        b(D, "class", "bg-gray-900 text-neutral-200 dark"),
        b(A, "class", "svelte-1qrsmpk"),
        je(A, "active", s[2] === "date"),
        b(J, "class", "svelte-1qrsmpk"),
        je(J, "active", s[2] === "stars"),
        b(ie, "class", "flex justify-center space-x-6"),
        b(ne, "class", "bg-neutral-50 border-b border-neutral-200 py-4");
    },
    m(h, v) {
      fe(t, h, v),
        q(h, n, v),
        ...
        _(N, oe),
        _(N, K);
      for (let Z = 0; Z < M.length; Z += 1) M[Z] && M[Z].m(K, null);
      q(h, pe, v),
        q(h, ne, v),
        _(ne, ie),
        _(ie, A),
        ...
        _(J, U),
        q(h, d, v);
      for (let Z = 0; Z < $.length; Z += 1) $[Z] && $[Z].m(h, v);
      q(h, ae, v),
        (te = !0),
        E || ((ce = [it(A, "click", s[7]), it(J, "click", s[8])]), (E = !0));
    },
    p(h, [v]) {
      v & 34 &&
        ((ue = h[1]), (M = at(M, v, ye, 1, h, ue, we, K, yr, kt, null, vt))),
        (!te || v & 4) && je(A, "active", h[2] === "date"),
        (!te || v & 4) && je(J, "active", h[2] === "stars"),
        v & 125 &&
          ((ge = h[2] === "date" ? h[4] : h[3]),
          $r(),
          ($ = at($, v, Te, 1, h, ge, Y, ae.parentNode, xr, wt, ae, bt)),
          vr());
    },
    i(h) {
      if (!te) {
        re(t.$$.fragment, h), re(le.$$.fragment, h), re(P.$$.fragment, h);
        for (let v = 0; v < ge.length; v += 1) re($[v]);
        te = !0;
      }
    },
    o(h) {
      se(t.$$.fragment, h), se(le.$$.fragment, h), se(P.$$.fragment, h);
      for (let v = 0; v < $.length; v += 1) se($[v]);
      te = !1;
    },
    d(h) {
      _e(t, h), h && f(n), h && f(e), h && f(C), h && f(D);
      for (let v = 0; v < M.length; v += 1) M[v].d();
      h && f(pe), h && f(ne), _e(le), _e(P), h && f(d);
      for (let v = 0; v < $.length; v += 1) $[v].d(h);
      h && f(ae), (E = !1), kr(ce);
    },
  };
}
function He(s) {
  var t;
  return (t = s.match(/\.\.\/projects\/(.*)\.md$/)) == null ? void 0 : t[1];
}
function ml(s, t, n) {
  let e, i, a, r;
  wr(s, jr, (p) => n(9, (r = p)));
  const o = Object.assign({
      "../../projects/bore.md": Cr,
      "../../projects/char-rnn-keras.md": qr,
      "../../projects/classes-wtf.md": Ur,
      "../../projects/composing-studio.md": Br,
      "../../projects/crepe.md": Nr,
      "../../projects/dispict.md": Zr,
      "../../projects/fastseg.md": Qr,
      "../../projects/game-of-life.md": Kr,
      "../../projects/graphics-workshop.md": Xr,
      "../../projects/gravity.md": ts,
      "../../projects/harmony.md": is,
      "../../projects/inline-sql.md": rs,
      "../../projects/julia-fractal.md": os,
      "../../projects/langevin-music.md": cs,
      "../../projects/library.md": us,
      "../../projects/percival.md": gs,
      "../../projects/redis-rope.md": ms,
      "../../projects/rpt.md": _s,
      "../../projects/rushlight.md": vs,
      "../../projects/rustpad.md": ws,
      "../../projects/setwithfriends.md": $s,
      "../../projects/sketching.md": js,
      "../../projects/sshx.md": zs,
      "../../projects/triangulate.md": Os,
      "../../projects/ukanren-rs.md": Is,
      "../../projects/vae-cnn-mnist.md": Ps,
      "../../projects/wkspace.md": Ds,
    }),
    l = Object.assign({
      "../../projects/bore.png": Cs,
      "../../projects/char-rnn-keras.png": qs,
      "../../projects/classes-wtf.png": Us,
      "../../projects/composing-studio.png": Bs,
      "../../projects/crepe.png": Ns,
      "../../projects/dispict.jpg": Zs,
      "../../projects/fastseg.jpg": Qs,
      "../../projects/game-of-life.png": Ks,
      "../../projects/graphics-workshop.png": Xs,
      "../../projects/gravity.png": to,
      "../../projects/harmony.png": io,
      "../../projects/inline-sql.png": ro,
      "../../projects/julia-1.jpg": oo,
      "../../projects/julia-2.jpg": co,
      "../../projects/julia-3.jpg": uo,
      "../../projects/julia-4.jpg": go,
      "../../projects/langevin-music.png": fo,
      "../../projects/library.png": bo,
      "../../projects/percival.png": ko,
      "../../projects/redis-rope.svg": yo,
      "../../projects/rpt.jpg": xo,
      "../../projects/rushlight.jpg": So,
      "../../projects/rustpad.png": To,
      "../../projects/setwithfriends.png": Ro,
      "../../projects/sketching.png": Lo,
      "../../projects/sshx.png": Mo,
      "../../projects/triangulate.png": Ao,
      "../../projects/ukanren-rs.png": Eo,
      "../../projects/vae-cnn-mnist.png": Go,
      "../../projects/wkspace.png": Ho,
    });
  rt(() => {
    const p = r.url.hash.slice(1);
    p &&
      setTimeout(() => {
        var O;
        r.url.hash.slice(1) === p &&
          ((O = document.getElementById(p)) == null || O.scrollIntoView());
      }, 500);
  });
  let c = null;
  rt(async () => {
    ...
    n(0, (c = {}));
    for (const R of O) n(0, (c[R.full_name] = R.stargazers_count), c);
  });
  let u = "date";
  const m = () => n(2, (u = "date")),
    y = () => n(2, (u = "stars"));
    ...
    (s.$$.update = () => {
      s.$$.dirty & 3 &&
        n(
          3,
          (a = [...i].sort((p, O) => {
            const R = (c == null ? void 0 : c[o[p].repo]) ?? 0;
            return ((c == null ? void 0 : c[o[O].repo]) ?? 0) - R;
          }))
        );
    }),
    n(4, (e = Object.keys(o).sort((p, O) => o[O].date - o[p].date))),
    n(
      1,
      (i = Object.keys(o).sort((p, O) => {
        const R = o[p].title.toLowerCase(),
          L = o[O].title.toLowerCase();
