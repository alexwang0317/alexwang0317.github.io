...
import { S as un } from "../chunks/Seo.4277da45.js";
function pn(yt) {
  let _,
    E,
    m,
  ...
  return (
    ...
    })),
    {
      c() {
        nn(_.$$.fragment),
          ...
          (te = u()),
          (j = o("h1")),
          (ne = t("functools.partial")),
          (ae = u()),
          (C = o("div")),
          (oe = t("July 20, 2025 • 5 min read")),
          (le = u()),
          (k = o("div")),
          (ie =
            t(`Master Python's functools.partial for elegant function composition and
    ...
    more maintainable codebases.`)),
          ...
          ($ = o("p")),
          (se =
            t(`You may find yourself in a situation where you need to call the same
      ...
      function over and over with the same fixed arguments:`)),
          ...
          (v = o("code")),
          (me =
            t(`# You end up with repetitive calls like this throughout your codebase
send_email(
    ...
    context=`)),
          ...
          (w = o("p")),
          (_e = t(
            "This repetition creates several problems: your code becomes "
          )),
          (W = o("strong")),
          (ye = t("verbose")),
          (ge = t(`
      and `)),
          (Y = o("strong")),
          (ve = t("harder to scan")),
          (be = t(`, you're constantly filling in the same
      ...
      difficult to read/write.`)),
          ...
          (z = o("pre")),
          (b = o("code")),
          (Ee = t(`from functools import partial
...
welcome_email(to_email='newuser@example.com', context=`)),
          (xe = t(bt)),
          (Te = t("username': 'jane_smith'")),
          (Ie = t(wt)),
          (Pe = t(")")),
          (je = u()),
          (O = o("p")),
          (R = o("code")),
          (Ce = t("functools.partial")),
          (ke = t(` allows you to "freeze" arguments and keywords,
      ...
      stay constant across multiple calls, partial eliminates the repetitive boilerplate.`)),
          (Oe = u()),
          (q = o("p")),
          (Me = t("This may be useful for:")),
          (Ne = u()),
          (g = o("ul")),
          (B = o("li")),
          (De = t("API clients with consistent authentication headers")),
          (Le = u()),
          (V = o("li")),
          (Se = t(
          ...
          (Fe = u()),
          (G = o("li")),
          ($e = t("File processors with common parsing configurations")),
          (Ae = u()),
          (U = o("li")),
          (We = t("Test fixtures requiring repeated setup parameters")),
          (Ye = u()),
          (H = o("h2")),
          (ze = t("Important Behavior with Mutable vs Immutable Arguments")),
          (Re = u()),
          (I = o("p")),
          (qe = t("When declaring ")),
          (J = o("code")),
          (Be = t("functools.partial")),
          (Ve = t(`, recognize that any
      ...
      while changes to mutable argument types do affect partials.`)),
          ...
          (Q = o("pre")),
          (s = o("code")),
          (Ue = t(`# 1. Immutable vs Mutable behavior
...
print(db_connector('localhost', 5432))  # Output: "...timeout 60"`)),
          ...
          (K = o("strong")),
          (ut = t("Tip:")),
          (pt = t(" Use keyword arguments in your partials for readability.")),
          (dt = u()),
          (N = o("div")),
          (D = o("p")),
          (ht = t("Questions or feedback? Feel free to reach out!")),
          this.h();
      },
      l(f) {
        an(_.$$.fragment, f), (E = p(f)), (m = l(f, "ARTICLE", { class: !0 }));
        var h = i(m);
        P = l(h, "DIV", { class: !0 });
        var Ot = i(P);
        T = l(Ot, "A", { href: !0, class: !0 });
        var Mt = i(T);
        (ee = n(Mt, "← Back to Python")),
          Mt.forEach(a),
          Ot.forEach(a),
          (te = p(h)),
          (j = l(h, "H1", { class: !0 }));
        var Nt = i(j);
        (ne = n(Nt, "functools.partial")),
          Nt.forEach(a),
          (ae = p(h)),
          (C = l(h, "DIV", { class: !0 }));
        var Dt = i(C);
        (oe = n(Dt, "July 20, 2025 • 5 min read")),
          Dt.forEach(a),
          (le = p(h)),
          (k = l(h, "DIV", { class: !0 }));
        var Lt = i(k);
...
send_email(
    ...
    context=`
      ...
      and `
          ...
          (Y = l(S, "STRONG", {}));
        var At = i(Y);
        (ve = n(At, "harder to scan")),
          At.forEach(a),
          (be = n(
            S,
            `, you're constantly filling in the same
      parameter values, and if you need to change the common settings (like the
      SMTP host or retry configuration), you'd have to hunt down and update
      every single function call. This makes your code less maintainable and
      difficult to read/write.`
...
welcome_email(to_email='newuser@example.com', context=`
        ...
        R = l(ft, "CODE", {});
        var Yt = i(R);
        (Ce = n(Yt, "functools.partial")),
          Yt.forEach(a),
          (ke = n(
            ft,
            ` allows you to "freeze" arguments and keywords,
      creating a simplified function with fewer parameters. When configuration values
      stay constant across multiple calls, partial eliminates the repetitive boilerplate.`
          )),
          ft.forEach(a),
          ...
          (q = l(c, "P", {}));
        var zt = i(q);
        (Me = n(zt, "This may be useful for:")),
          zt.forEach(a),
          (Ne = p(c)),
          (g = l(c, "UL", {}));
        var x = i(g);
        B = l(x, "LI", {});
        var Rt = i(B);
        (De = n(Rt, "API clients with consistent authentication headers")),
          Rt.forEach(a),
          (Le = p(x)),
          (V = l(x, "LI", {}));
        var qt = i(V);
        (Se = n(
          ...
          (G = l(x, "LI", {}));
        var Bt = i(G);
        ($e = n(Bt, "File processors with common parsing configurations")),
          Bt.forEach(a),
          (Ae = p(x)),
          (U = l(x, "LI", {}));
        var Vt = i(U);
        (We = n(Vt, "Test fixtures requiring repeated setup parameters")),
          Vt.forEach(a),
          x.forEach(a),
          (Ye = p(c)),
          (H = l(c, "H2", {}));
        var Gt = i(H);
        (ze = n(Gt, "Important Behavior with Mutable vs Immutable Arguments")),
          Gt.forEach(a),
          (Re = p(c)),
          (I = l(c, "P", {}));
        var Z = i(I);
        (qe = n(Z, "When declaring ")), (J = l(Z, "CODE", {}));
        var Ut = i(J);
        (Be = n(Ut, "functools.partial")),
          Ut.forEach(a),
          (Ve = n(
            Z,
            `, recognize that any
...
print(db_connector('localhost', 5432))  # Output: "...timeout 60"`
        ...
        (ut = n(Jt, "Tip:")),
          ...
          (pt = n(
            _t,
            " Use keyword arguments in your partials for readability."
          )),
          _t.forEach(a),
          c.forEach(a),
          (dt = p(h)),
        ...
        D = l(Qt, "P", { class: !0 });
        var Kt = i(D);
        (ht = n(Kt, "Questions or feedback? Feel free to reach out!")),
          Kt.forEach(a),
          Qt.forEach(a),
          h.forEach(a),
          this.h();
      ...
      h() {
        y(T, "href", "/python"),
          y(T, "class", "text-blue-600 hover:underline text-sm"),
          y(P, "class", "mb-8"),
          y(j, "class", "text-3xl font-bold mb-4"),
          y(C, "class", "text-sm text-neutral-500 mb-8"),
          y(k, "class", "text-lg text-neutral-700 mb-8 leading-relaxed"),
          y(v, "class", "language-python"),
          y(b, "class", "language-python"),
          y(s, "class", "language-python"),
          y(r, "class", "prose prose-neutral max-w-none"),
          y(D, "class", "text-sm text-neutral-500"),
          y(N, "class", "border-t pt-8 mt-12"),
          y(
            m,
            "class",
