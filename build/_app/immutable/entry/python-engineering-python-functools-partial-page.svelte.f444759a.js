import{S as Zt,i as en,s as tn,y as nn,a as u,k as o,q as t,z as an,c as p,l,m as i,r as n,h as a,n as y,A as on,b as Xt,C as e,F as ln,g as rn,d as sn,B as cn,o as mn}from"../chunks/index.dd6ea1d3.js";import{S as un}from"../chunks/Seo.4277da45.js";function pn(yt){let _,E,m,P,T,ee,te,j,ne,ae,C,oe,le,k,ie,re,r,$,se,ce,A,v,me,gt="{",ue,pe,vt="}",de,he,fe,w,_e,W,ye,ge,Y,ve,be,we,z,b,Ee,bt="{",xe,Te,wt="}",Ie,Pe,je,O,R,Ce,ke,Oe,q,Me,Ne,g,B,De,Le,V,Se,Fe,G,$e,Ae,U,We,Ye,H,ze,Re,I,qe,J,Be,Ve,Ge,Q,s,Ue,Et="{",He,Je,xt="}",Qe,Ke,Tt="{",Xe,Ze,It="}",et,tt,Pt="{",nt,at,jt="}",ot,lt,Ct="{",it,rt,kt="}",st,ct,mt,M,K,ut,pt,dt,N,D,ht,X;return _=new un({props:{title:"functools.partial - Alex Wang",description:"functools.partial for elegant function composition and cleaner code"}}),{c(){nn(_.$$.fragment),E=u(),m=o("article"),P=o("div"),T=o("a"),ee=t("← Back to Python"),te=u(),j=o("h1"),ne=t("functools.partial"),ae=u(),C=o("div"),oe=t("July 20, 2025 • 5 min read"),le=u(),k=o("div"),ie=t(`Master Python's functools.partial for elegant function composition and
...
welcome_email(to_email='newuser@example.com', context=`),xe=t(bt),Te=t("username': 'jane_smith'"),Ie=t(wt),Pe=t(")"),je=u(),O=o("p"),R=o("code"),Ce=t("functools.partial"),ke=t(` allows you to "freeze" arguments and keywords,
      ...
      stay constant across multiple calls, partial eliminates the repetitive boilerplate.`),Oe=u(),q=o("p"),Me=t("This may be useful for:"),Ne=u(),g=o("ul"),B=o("li"),De=t("API clients with consistent authentication headers"),Le=u(),V=o("li"),Se=t("Database connections with standard timeout and pool settings"),Fe=u(),G=o("li"),$e=t("File processors with common parsing configurations"),Ae=u(),U=o("li"),We=t("Test fixtures requiring repeated setup parameters"),Ye=u(),H=o("h2"),ze=t("Important Behavior with Mutable vs Immutable Arguments"),Re=u(),I=o("p"),qe=t("When declaring "),J=o("code"),Be=t("functools.partial"),Ve=t(`, recognize that any
      immutable argument types will use the values declared at creation time,
      while changes to mutable argument types do affect partials.`),Ge=u(),Q=o("pre"),s=o("code"),Ue=t(`# 1. Immutable vs Mutable behavior
...
config_dict = `),He=t(Et),Je=t("timeout': 30"),Qe=t(xt),Ke=t(`
...
print(db_connector('localhost', 5432))  # Output: "...timeout 60"`),mt=u(),M=o("p"),K=o("strong"),ut=t("Tip:"),pt=t(" Use keyword arguments in your partials for readability."),dt=u(),N=o("div"),D=o("p"),ht=t("Questions or feedback? Feel free to reach out!"),this.h()},l(f){an(_.$$.fragment,f),E=p(f),m=l(f,"ARTICLE",{class:!0});var h=i(m);P=l(h,"DIV",{class:!0});var Ot=i(P);T=l(Ot,"A",{href:!0,class:!0});var Mt=i(T);ee=n(Mt,"← Back to Python"),Mt.forEach(a),Ot.forEach(a),te=p(h),j=l(h,"H1",{class:!0});var Nt=i(j);ne=n(Nt,"functools.partial"),Nt.forEach(a),ae=p(h),C=l(h,"DIV",{class:!0});var Dt=i(C);oe=n(Dt,"July 20, 2025 • 5 min read"),Dt.forEach(a),le=p(h),k=l(h,"DIV",{class:!0});var Lt=i(k);ie=n(Lt,`Master Python's functools.partial for elegant function composition and
    cleaner code. Learn how to eliminate repetitive function calls and create
...
welcome_email(to_email='newuser@example.com', context=`),xe=n(F,bt),Te=n(F,"username': 'jane_smith'"),Ie=n(F,wt),Pe=n(F,")"),F.forEach(a),Wt.forEach(a),je=p(c),O=l(c,"P",{});var ft=i(O);R=l(ft,"CODE",{});var Yt=i(R);Ce=n(Yt,"functools.partial"),Yt.forEach(a),ke=n(ft,` allows you to "freeze" arguments and keywords,
      creating a simplified function with fewer parameters. When configuration values
      stay constant across multiple calls, partial eliminates the repetitive boilerplate.`),ft.forEach(a),Oe=p(c),q=l(c,"P",{});var zt=i(q);Me=n(zt,"This may be useful for:"),zt.forEach(a),Ne=p(c),g=l(c,"UL",{});var x=i(g);B=l(x,"LI",{});var Rt=i(B);De=n(Rt,"API clients with consistent authentication headers"),Rt.forEach(a),Le=p(x),V=l(x,"LI",{});var qt=i(V);Se=n(qt,"Database connections with standard timeout and pool settings"),qt.forEach(a),Fe=p(x),G=l(x,"LI",{});var Bt=i(G);$e=n(Bt,"File processors with common parsing configurations"),Bt.forEach(a),Ae=p(x),U=l(x,"LI",{});var Vt=i(U);We=n(Vt,"Test fixtures requiring repeated setup parameters"),Vt.forEach(a),x.forEach(a),Ye=p(c),H=l(c,"H2",{});var Gt=i(H);ze=n(Gt,"Important Behavior with Mutable vs Immutable Arguments"),Gt.forEach(a),Re=p(c),I=l(c,"P",{});var Z=i(I);qe=n(Z,"When declaring "),J=l(Z,"CODE",{});var Ut=i(J);Be=n(Ut,"functools.partial"),Ut.forEach(a),Ve=n(Z,`, recognize that any
      immutable argument types will use the values declared at creation time,
      while changes to mutable argument types do affect partials.`),Z.forEach(a),Ge=p(c),Q=l(c,"PRE",{});var Ht=i(Q);s=l(Ht,"CODE",{class:!0});var d=i(s);Ue=n(d,`# 1. Immutable vs Mutable behavior
def process_data(base_value, multiplier):
    return base_value * multiplier
...
# Mutable example - changes affect the partial
config_dict = `),He=n(d,Et),Je=n(d,"timeout': 30"),Qe=n(d,xt),Ke=n(d,`
...
config_dict['timeout'] = 60  # This WILL affect the partial
print(db_connector('localhost', 5432))  # Output: "...timeout 60"`),d.forEach(a),Ht.forEach(a),mt=p(c),M=l(c,"P",{});var _t=i(M);K=l(_t,"STRONG",{});var Jt=i(K);ut=n(Jt,"Tip:"),Jt.forEach(a),pt=n(_t," Use keyword arguments in your partials for readability."),_t.forEach(a),c.forEach(a),dt=p(h),N=l(h,"DIV",{class:!0});var Qt=i(N);D=l(Qt,"P",{class:!0});var Kt=i(D);ht=n(Kt,"Questions or feedback? Feel free to reach out!"),Kt.forEach(a),Qt.forEach(a),h.forEach(a),this.h()},h(){y(T,"href","/python"),y(T,"class","text-blue-600 hover:underline text-sm"),y(P,"class","mb-8"),y(j,"class","text-3xl font-bold mb-4"),y(C,"class","text-sm text-neutral-500 mb-8"),y(k,"class","text-lg text-neutral-700 mb-8 leading-relaxed"),y(v,"class","language-python"),y(b,"class","language-python"),y(s,"class","language-python"),y(r,"class","prose prose-neutral max-w-none"),y(D,"class","text-sm text-neutral-500"),y(N,"class","border-t pt-8 mt-12"),y(m,"class","layout-md py-12 mx-auto max-w-3xl px-6 svelte-1l0sx6b")},m(f,h){on(_,f,h),Xt(f,E,h),Xt(f,m,h),e(m,P),e(P,T),e(T,ee),e(m,te),e(m,j),e(j,ne),e(m,ae),e(m,C),e(C,oe),e(m,le),e(m,k),e(k,ie),e(m,re),e(m,r),e(r,$),e($,se),e(r,ce),e(r,A),e(A,v),e(v,me),e(v,ue),e(v,pe),e(v,de),e(v,he),e(r,fe),e(r,w),e(w,_e),e(w,W),e(W,ye),e(w,ge),e(w,Y),e(Y,ve),e(w,be),e(r,we),e(r,z),e(z,b),e(b,Ee),e(b,xe),e(b,Te),e(b,Ie),e(b,Pe),e(r,je),e(r,O),e(O,R),e(R,Ce),e(O,ke),e(r,Oe),e(r,q),e(q,Me),e(r,Ne),e(r,g),e(g,B),e(B,De),e(g,Le),e(g,V),e(V,Se),e(g,Fe),e(g,G),e(G,$e),e(g,Ae),e(g,U),e(U,We),e(r,Ye),e(r,H),e(H,ze),e(r,Re),e(r,I),e(I,qe),e(I,J),e(J,Be),e(I,Ve),e(r,Ge),e(r,Q),e(Q,s),e(s,Ue),e(s,He),e(s,Je),e(s,Qe),e(s,Ke),e(s,Xe),e(s,Ze),e(s,et),e(s,tt),e(s,nt),e(s,at),e(s,ot),e(s,lt),e(s,it),e(s,rt),e(s,st),e(s,ct),e(r,mt),e(r,M),e(M,K),e(K,ut),e(M,pt),e(m,dt),e(m,N),e(N,D),e(D,ht),X=!0},p:ln,i(f){X||(rn(_.$$.fragment,f),X=!0)},o(f){sn(_.$$.fragment,f),X=!1},d(f){cn(_,f),f&&a(E),f&&a(m)}}}function dn(yt){return mn(async()=>{if(typeof window<"u"&&!window.Prism){const _=document.createElement("link");_.rel="stylesheet",_.href="https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/themes/prism-tomorrow.min.css",document.head.appendChild(_);const E=document.createElement("script");E.src="https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/prism.min.js",E.onload=()=>{const m=document.createElement("script");m.src="https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/components/prism-python.min.js",m.onload=()=>{window.Prism.highlightAll()},document.head.appendChild(m)},document.head.appendChild(E)}}),[]}class _n extends Zt{constructor(_){super(),en(this,_,dn,pn,tn,{})}}export{_n as default};
