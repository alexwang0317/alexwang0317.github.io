...
import { S as Gt } from "../chunks/Seo.4277da45.js";
function Nt(tt) {
  let f,
    y,
    c,
  ...
  return (
    ...
    })),
    {
      c() {
        Tt(f.$$.fragment),
          ...
          (ae = g()),
          (z = l("div")),
          (se = n("September 4, 2025 • 5 min read")),
          (re = g()),
          (F = l("div")),
          (ie =
            n(`Learn how to optimize Python logging performance with lazy evaluation
    ...
    when logs aren't actually output.`)),
          ...
          ($ = l("p")),
          (ge =
            n(`When writing programs, oftentimes during development/production there are
...
...`)),
          ...
          (S = l("p")),
          (_e =
            n(`However, in the case we are using the default log level of INFO in which
      ...
      things:`)),
          ...
          (N = l("code")),
          (ze = n("expensive_func")),
          (Fe = n(" is called when not needed.")),
          (Oe = g()),
          (q = l("p")),
          (Pe =
            n(`To address problem 1, we can call logging methods with a string literal
...
...`)),
          (Ae = g()),
          (b = l("p")),
          (Te = n("To address problem 2, we can use the ")),
          (V = l("code")),
          (ke = n("isEnabledFor()")),
          (Be = n(` method which
...
...`)),
          ...
          (x = l("p")),
          (Se = n(
            "This means that unless the threshold is set above DEBUG level, the call to "
          )),
          (Q = l("code")),
          (Ue = n("expensive_func()")),
          (Ge = n(`
      is never made.`)),
          (Ne = g()),
          (_ = l("p")),
          (qe = n("If this is consistently called, you can use ")),
          (M = l("code")),
          (He = n("LoggerAdapter")),
          (Ve = n(`
      ...
      `)),
          ...
          (K = l("pre")),
          (C = l("code")),
          (Je = n(`from logging import LoggerAdapter
...
lazy_logger.lazy_log(logging.INFO, expensive_operation)   # Function IS called!`)),
          ...
          (A = l("div")),
          (T = l("p")),
          (Ze = n("Questions or feedback? Feel free to reach out!")),
          this.h();
      },
      l(u) {
        kt(f.$$.fragment, u), (y = d(u)), (c = a(u, "ARTICLE", { class: !0 }));
        var p = s(c);
        D = a(p, "DIV", { class: !0 });
        var lt = s(D);
        E = a(lt, "A", { href: !0, class: !0 });
        var at = s(E);
        (ne = o(at, "← Back to Python")),
          at.forEach(t),
          lt.forEach(t),
          (oe = d(p)),
          (L = a(p, "H1", { class: !0 }));
        var st = s(L);
        (le = o(st, "Lazy Logging")),
          st.forEach(t),
          (ae = d(p)),
          (z = a(p, "DIV", { class: !0 }));
        var rt = s(z);
        (se = o(rt, "September 4, 2025 • 5 min read")),
          rt.forEach(t),
          (re = d(p)),
          (F = a(p, "DIV", { class: !0 }));
        var it = s(F);
...
...`
      ...
      things:`
        ...
        N = a(et, "CODE", {});
        var ht = s(N);
        (ze = o(ht, "expensive_func")),
          ht.forEach(t),
          (Fe = o(et, " is called when not needed.")),
          et.forEach(t),
          Z.forEach(t),
          (Oe = d(i)),
          (q = a(i, "P", {}));
...
...`
          ...
          (b = a(i, "P", {}));
        var ee = s(b);
        (Te = o(ee, "To address problem 2, we can use the ")),
          (V = a(ee, "CODE", {}));
        var _t = s(V);
        (ke = o(_t, "isEnabledFor()")),
          _t.forEach(t),
          (Be = o(
            ee,
            ` method which
...
...`
      ...
      is never made.`
          ...
          (_ = a(i, "P", {}));
        var j = s(_);
        (qe = o(j, "If this is consistently called, you can use ")),
          (M = a(j, "CODE", {}));
        var bt = s(M);
        (He = o(bt, "LoggerAdapter")),
          bt.forEach(t),
          (Ve = o(
            j,
            `
...
lazy_logger.lazy_log(logging.INFO, expensive_operation)   # Function IS called!`
        ...
        T = a(Ft, "P", { class: !0 });
        var Ot = s(T);
        (Ze = o(Ot, "Questions or feedback? Feel free to reach out!")),
          Ot.forEach(t),
          Ft.forEach(t),
          p.forEach(t),
          this.h();
      ...
      h() {
        h(E, "href", "/python"),
          h(E, "class", "text-blue-600 hover:underline text-sm"),
          h(D, "class", "mb-8"),
          h(L, "class", "text-3xl font-bold mb-4"),
          h(z, "class", "text-sm text-neutral-500 mb-8"),
          h(F, "class", "text-lg text-neutral-700 mb-8 leading-relaxed"),
          h(m, "class", "language-python"),
          h(P, "class", "language-python"),
          h(I, "class", "language-python"),
          h(C, "class", "language-python"),
          h(r, "class", "prose prose-neutral max-w-none"),
          h(T, "class", "text-sm text-neutral-500"),
          h(A, "class", "border-t pt-8 mt-12"),
          h(
            c,
            "class",
