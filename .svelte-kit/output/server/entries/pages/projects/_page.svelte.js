...
const Calendar_days = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `${validate_component(Icon, "Icon").$$render(
      $$result,
      Object.assign({}, { name: "calendar-days" }, $$props, { iconNode }),
      {},
      {
        default: () => {
...
const Star = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon, "Icon").$$render(
    $$result,
    Object.assign({}, { name: "star" }, $$props, { iconNode }),
    {},
    {
      default: () => {
        return `${slots.default ? slots.default({}) : ``}`;
...
var topics$p = ["Python", "Machine Learning", "Music"];
var lead$p =
...
var topics$o = ["Go", "TypeScript", "Svelte", "Systems"];
...
var topics$n = ["TypeScript", "Rust", "Music", "React"];
...
var topics$m = ["Rust", "Programming Languages", "Datalog"];
var lead$m =
...
var topics$l = ["Python", "Svelte", "Art", "Vision"];
...
var topics$k = ["Python", "Machine Learning", "Vision"];
var lead$k =
...
var topics$j = ["JavaScript", "Algorithms", "Graphics", "Vue"];
var lead$j =
...
var topics$i = ["OpenGL", "Graphics", "Shaders"];
...
var topics$h = ["JavaScript", "Graphics", "Physics"];
...
var topics$g = ["Python", "Music", "Algorithms", "Flask"];
...
var topics$f = ["Python", "Programming Languages", "Databases"];
...
var topics$e = ["C++", "Java", "Graphics", "TypeScript", "OpenGL"];
var lead$e = "Fast, interactive fractal renderers in C++, Java, and WebGL.";
var image$e = "julia-1.jpg";
var subimages = ["julia-2.jpg", "julia-3.jpg", "julia-4.jpg"];
var content$e =
...
var topics$d = ["Python", "Machine Learning", "Music", "Transformers"];
...
var topics$c = ["C++", "CP", "Algorithms", "Angular"];
var lead$c =
...
var topics$b = ["Rust", "Svelte", "Datalog", "Visualization"];
...
var topics$a = ["Zig", "Rust", "Systems", "Algorithms"];
...
var topics$9 = ["Rust", "Graphics", "Rendering"];
...
var topics$8 = ["TypeScript", "Systems", "Redis"];
...
var topics$7 = ["Rust", "Systems", "TypeScript", "React"];
...
var topics$6 = ["JavaScript", "Game", "React", "Firebase"];
...
var topics$5 = ["OpenGL", "Graphics", "Geometry", "Algorithms"];
...
var topics$4 = ["Rust", "Svelte", "Systems"];
...
var topics$3 = ["C++", "Algorithms", "Emscripten", "Graphics"];
...
var topics$2 = ["Rust", "Programming Languages", "Systems"];
...
var topics$1 = ["Python", "Machine Learning", "Graphics"];
var lead$1 =
...
var topics = ["JavaScript", "CP", "React", "Express"];
var lead =
...
const graphicsWorkshop =
  "/_app/immutable/assets/graphics-workshop.8c21b2ee.png";
...
const Markdown = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let html;
    let { source } = $$props;
    marked.use({
...
const Project = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
<h3 class="text-black text-xl font-semibold mb-2"><span class="mr-1">${escape(
    data.title
  )}</span>
  <small class="whitespace-nowrap text-neutral-500 text-base font-normal">${escape(
    formatTime("%B %Y", data.date)
  )}</small></h3>


<div class="flex flex-wrap mb-1"><a class="pill hover:!bg-neutral-200 transition-colors svelte-1d8a62h" href="${
    "https://github.com/" + escape(data.repo, true) + "/stargazers"
  }">${validate_component(Star, "Star").$$render(
    $$result,
    { size: 14, class: "fill-current" },
    {},
    {}
  )}
    ${
      stars?.[data.repo] !== void 0
        ? `<span class="ml-1">${escape(
            stars[data.repo].toLocaleString()
          )}</span>`
        : `<span>​</span>`
    }</a>
...
<div class="space-y-4"><div class="grid grid-cols-3 gap-4 md:gap-8 lg:gap-12"><div class="col-span-3 md:col-span-2"><p class="text-lg font-light mb-3">${escape(
    data.lead
  )}</p>
    ...
    <div class="col-span-3 md:col-span-1"><a rel="external"${add_attribute(
      "href",
      images[`../../projects/${data.image}`]?.default,
      0
    )}><img${add_attribute(
    "src",
    images[`../../projects/${data.image}`]?.default,
    0
  )} alt="${escape(data.title, true) + " preview image"}"${add_classes(
    (data.image_border ? "border" : "").trim()
  )}></a></div></div>

  ${
    data.subimages
      ? `<div class="grid grid-cols-3 gap-4 md:gap-8 lg:gap-12">${each(
          data.subimages,
          (image2) => {
            return `<div class="col-span-full md:col-span-1"><a rel="external"${add_attribute(
              "href",
              images[`../../projects/${image2}`]?.default,
              0
            )}><img${add_attribute(
              "src",
              images[`../../projects/${image2}`]?.default,
              0
            )} alt="${escape(data.title, true) + " subimage"}"></a>
        </div>`;
          }
        )}</div>`
      : ``
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const projects = /* @__PURE__ */ Object.assign({
    "../../projects/bore.md": __vite_glob_0_0,
    "../../projects/char-rnn-keras.md": __vite_glob_0_1,
    "../../projects/classes-wtf.md": __vite_glob_0_2,
    "../../projects/composing-studio.md": __vite_glob_0_3,
    "../../projects/crepe.md": __vite_glob_0_4,
    "../../projects/dispict.md": __vite_glob_0_5,
    "../../projects/fastseg.md": __vite_glob_0_6,
    "../../projects/game-of-life.md": __vite_glob_0_7,
    "../../projects/graphics-workshop.md": __vite_glob_0_8,
    "../../projects/gravity.md": __vite_glob_0_9,
    "../../projects/harmony.md": __vite_glob_0_10,
    "../../projects/inline-sql.md": __vite_glob_0_11,
    "../../projects/julia-fractal.md": __vite_glob_0_12,
    "../../projects/langevin-music.md": __vite_glob_0_13,
    "../../projects/library.md": __vite_glob_0_14,
    "../../projects/percival.md": __vite_glob_0_15,
    "../../projects/redis-rope.md": __vite_glob_0_16,
    "../../projects/rpt.md": __vite_glob_0_17,
    "../../projects/rushlight.md": __vite_glob_0_18,
    "../../projects/rustpad.md": __vite_glob_0_19,
    "../../projects/setwithfriends.md": __vite_glob_0_20,
    "../../projects/sketching.md": __vite_glob_0_21,
    "../../projects/sshx.md": __vite_glob_0_22,
    "../../projects/triangulate.md": __vite_glob_0_23,
    "../../projects/ukanren-rs.md": __vite_glob_0_24,
    "../../projects/vae-cnn-mnist.md": __vite_glob_0_25,
    "../../projects/wkspace.md": __vite_glob_0_26,
  });
  const images = /* @__PURE__ */ Object.assign({
    "../../projects/bore.png": __vite_glob_1_0,
    "../../projects/char-rnn-keras.png": __vite_glob_1_1,
    "../../projects/classes-wtf.png": __vite_glob_1_2,
    "../../projects/composing-studio.png": __vite_glob_1_3,
    "../../projects/crepe.png": __vite_glob_1_4,
    "../../projects/dispict.jpg": __vite_glob_1_5,
    "../../projects/fastseg.jpg": __vite_glob_1_6,
    "../../projects/game-of-life.png": __vite_glob_1_7,
    "../../projects/graphics-workshop.png": __vite_glob_1_8,
    "../../projects/gravity.png": __vite_glob_1_9,
    "../../projects/harmony.png": __vite_glob_1_10,
    "../../projects/inline-sql.png": __vite_glob_1_11,
    "../../projects/julia-1.jpg": __vite_glob_1_12,
    "../../projects/julia-2.jpg": __vite_glob_1_13,
    "../../projects/julia-3.jpg": __vite_glob_1_14,
    "../../projects/julia-4.jpg": __vite_glob_1_15,
    "../../projects/langevin-music.png": __vite_glob_1_16,
    "../../projects/library.png": __vite_glob_1_17,
    "../../projects/percival.png": __vite_glob_1_18,
    "../../projects/redis-rope.svg": __vite_glob_1_19,
    "../../projects/rpt.jpg": __vite_glob_1_20,
    "../../projects/rushlight.jpg": __vite_glob_1_21,
    "../../projects/rustpad.png": __vite_glob_1_22,
    "../../projects/setwithfriends.png": __vite_glob_1_23,
    "../../projects/sketching.png": __vite_glob_1_24,
    "../../projects/sshx.png": __vite_glob_1_25,
    "../../projects/triangulate.png": __vite_glob_1_26,
    "../../projects/ukanren-rs.png": __vite_glob_1_27,
    "../../projects/vae-cnn-mnist.png": __vite_glob_1_28,
    "../../projects/wkspace.png": __vite_glob_1_29,
  });
  let stars = null;
  $$result.css.add(css);
...
<div class="bg-gray-900 text-neutral-200 dark"><section class="layout-md py-12"><h2 class="heading2 text-white">Table of Contents</h2>
    <ul class="sm:columns-2">${each(projectsByTitle, (id) => {
      return `<li><a class="link" href="${
        "#" + escape(trimName(id), true)
      }">${escape(projects[id].title)}</a>
        </li>`;
    })}</ul></section></div>

<div class="bg-neutral-50 border-b border-neutral-200 py-4"><div class="flex justify-center space-x-6"><button class="${[
    "svelte-1qrsmpk",
    "active",
  ]
    .join(" ")
    .trim()}">${validate_component(Calendar_days, "CalendarDays").$$render(
    $$result,
    {
      size: 18,
      strokeWidth: 1.8,
    ...
    <button class="${["svelte-1qrsmpk", ""]
      .join(" ")
      .trim()}">${validate_component(Star, "Star").$$render(
    $$result,
    {
      size: 18,
      strokeWidth: 1.8,
...
${each(projectsByDate, (id) => {
  return `<section class="py-10"${add_attribute(
    "id",
    trimName(id),
    0
  )}><div class="mx-auto max-w-[1152px] px-4 sm:px-6">${validate_component(
    Project,
    "Project"
  ).$$render($$result, { data: projects[id], images, stars }, {}, {})}</div>
  </section>`;
})}`;
});
