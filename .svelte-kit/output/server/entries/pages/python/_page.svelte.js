...
<section class="layout-md py-12"><h2 class="heading2">Python Dev Notes</h2>
  ...
  ${data$1.posts && data$1.posts.length > 0 ? `${validate_component(PythonList, "PythonList").$$render($$result, { data: data$1.posts }, {}, {})}` : `<p class="text-neutral-600">Coming soon</p>`}</section>

<section class="layout-md py-12"><h2 class="heading2">Performative Python</h2>
  <div class="border-b border-neutral-300 mb-6"></div>
  ${data.posts && data.posts.length > 0 ? `${validate_component(PythonList, "PythonList").$$render($$result, { data: data.posts }, {}, {})}` : `<p class="text-neutral-600">Coming soon</p>`}</section>`;
});
export {
  Page as default
};
