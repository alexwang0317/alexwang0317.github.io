...
welcome_email(to_email=&#39;newuser@example.com&#39;, context=${escape(
    "{"
  )}username&#39;: &#39;jane_smith&#39;${escape("}")})</code></pre>
...
def connect_database(host, port, config):
    return f&quot;Connecting to ${escape("{")}host${escape("}")}:${escape(
    "{"
  )}port${escape("}")} with timeout ${escape(
    "{"
  )}config[&#39;timeout&#39;]${escape("}")}&quot;
