...
class VideoLogger(PostLogger):
    def log(self, post: VideoPost) -&gt; None:  # Type error!
        print(f&quot;Logging video: ${escape("{")}post.content${escape("}")} (duration: ${escape("{")}post.duration${escape("}")}s)&quot;)

class ImageLogger(PostLogger):
    def log(self, post: ImagePost) -&gt; None:  # Type error!
        print(f&quot;Logging image: ${escape("{")}post.content${escape("}")} (image: ${escape("{")}post.image_url${escape("}")}))&quot;)</code></pre>
