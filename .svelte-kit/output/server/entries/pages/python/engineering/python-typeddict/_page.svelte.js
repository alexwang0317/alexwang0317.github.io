...
def process_user(data: dict) -&gt; None:
    # we expect: ${escape("{")}\\&quot;id\\&quot;: int, \\&quot;email\\&quot;: str (optional)${escape("}")} 
    print(f&quot;User id = ${escape("{")}data[&#39;id&#39;]${escape("}")}&quot;)
    if &quot;email&quot; in data:
        print(f&quot;Email = ${escape("{")}data[&#39;email&#39;]${escape("}")}&quot;)</code></pre>
...
process_user(${escape("{")}\\&quot;id\\&quot;: 42${escape("}")})  # ✅ ok, email optional
process_user(${escape("{")}\\&quot;id\\&quot;: 42, \\&quot;email\\&quot;: \\&quot;alex@example.com\\&quot;${escape("}")})  # ✅ ok
process_user(${escape("{")}\\&quot;email\\&quot;: \\&quot;oops\\&quot;${escape("}")})  # ❌ type checker error: missing &quot;id&quot;</code></pre>
