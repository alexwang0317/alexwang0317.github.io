...
const Arrow_up_right = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `${validate_component(Icon, "Icon").$$render(
      $$result,
      Object.assign({}, { name: "arrow-up-right" }, $$props, { iconNode }),
      {},
      {
        default: () => {
...
const WritingList = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `<div class="grid gap-y-4">${each(data2, (item) => {
      return `<a${add_attribute(
        ...
        item.link,
        0
      )} class="block -mx-3 px-3 py-2 hover:bg-neutral-100 transition-colors" target="_blank" rel="noreferrer"><div class="flex flex-col sm:flex-row sm:items-end mb-1.5"><div class="text-lg text-black">${escape(
        item.title
      )}
...
var data = {
  essays: [
    ...
    },
    {
      ...
      summary:
        "How complaining is a sign of unresolved issues and prevents us from seeing progress.\n",
    ...
    },
    {
      ...
      summary:
        "A guide on decision-making and the importance of clarity and commitment.\n",
    ...
    },
    {
      ...
      summary:
        "Exploring risk-taking, agency, and navigating uncertainty in life and career.\n",
    ...
    },
    {
      ...
      summary:
        "The importance of curiosity over acceptance in learning and growth.\n",
...
<section class="layout-md py-12"><h2 class="heading2">Essays</h2>
  ${validate_component(WritingList, "WritingList").$$render(
    $$result,
    { data: data.essays },
    {},
    {}
