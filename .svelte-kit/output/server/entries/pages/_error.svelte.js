...
const Bug = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon, "Icon").$$render(
    $$result,
    Object.assign({}, { name: "bug" }, $$props, { iconNode }),
    {},
    {
      default: () => {
...
const Error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="layout-md"><div class="pt-14 pb-40 sm:pt-20 sm:pb-80 text-xl flex justify-center items-center">${validate_component(
    Bug,
    "Bug"
