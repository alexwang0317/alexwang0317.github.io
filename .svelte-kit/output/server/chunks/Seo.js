...
const Seo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${
    (($$result.head += `<!-- HEAD_svelte-1fbmuei_START -->${
      ...
      description,
      0
    )}><meta property="og:image" content="https://www.ekzhang.com/assets/images/hudson-landscape.jpg"><meta name="twitter:card" content="summary_large_image"><!-- HEAD_svelte-1fbmuei_END -->`),
    "")
  }`;
});
export { Seo as S };
